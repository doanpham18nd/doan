                    ...
                    <div className="col-sm-9">
                        <div className="">
                            <div className="features_items">
                                {/*<h2 className="title text-center">Purchase</h2>*/}
                                <ul className="nav nav-tabs">
                                    <li className="tab-purchase"><NavLink to={'/user/waiting.html'}>Chờ thanh toán</NavLink></li>
                                    <li className="tab-purchase tab-purchase-active"><NavLink to={'/user/delivering.html'}>Đang giao</NavLink></li>
