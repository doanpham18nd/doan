...
class MedicineController extends Controller
{
    ...
    {
        try {
            $symptomData['medicineDetail'] = Medicine::where('id', $id)->first();
            $symptomData['relatedActive'] = Medicine::where('category', $symptomData['medicineDetail']->category)->whereNotIn('id', [$id])->limit(3)->get();
            $symptomData['related'] = Medicine::where('category', $symptomData['medicineDetail']->category)->whereNotIn('id', [$id])->skip(3)->take(3)->get();
    ...
    {
        $data = Medicine::where('name', 'like', '%' . $request->keyword . '%')->get();
